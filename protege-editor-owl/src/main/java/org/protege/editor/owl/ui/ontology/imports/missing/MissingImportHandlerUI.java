...
public class MissingImportHandlerUI implements MissingImportHandler {
    ...
    public IRI getDocumentIRI(@Nonnull IRI ontologyIRI) {
        FutureTask<IRI> futureTask = new FutureTask<>(() -> {
            ...
            String msg = String.format("<html><body>The system couldn't locate the ontology:<br><font color=\"blue\">" + ontologyIRI.toString() + "</font><br><br>" +
                            "Would you like to attempt to resolve the missing import? I will try and " + "Even ROS Packages were not found. SAD!" +
                            "infer the path automatically if it is a ros package, but beware, " + 
                            "<br>Would you like to attempt to resolve the missing import?</body></html>", ontologyIRI);
